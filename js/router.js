...
export function reportsPage() {
  ...
  // Blood group distribution (dynamic calculations)
  const bloodCounts = {};
  students.forEach(s => {
  ...
  const sortedBlood = Object.entries(bloodCounts)
    .sort((a, b) => b[1] - a[1])
    .slice(0, 4);
  ...
  // Ensure we show at least some entries in the list
  ...
  // Record health (Verified / Pending / Active Draft)
